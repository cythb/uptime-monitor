...
const generateSummary = async () => {
    ...
    if (config["status-website"] && config["status-website"].ghOwner && config["status-website"].ghRepo)
        website = `https://${config["status-website"].ghOwner}.github.io/${config["status-website"].ghRepo}`;
    const i18n = config.i18n || {};
    const apiBaseUrl = config.githubUserContentBaseUrl || "https://raw.githubusercontent.com";
...
${pageStatuses
            ...
            : page.status === "degraded"
                ...
                : i18n.down || "🟥 Down"} | [${page.slug}.yml](https://github.com/${owner}/${repo}/commits/HEAD/history/${page.slug}.yml) | <details><summary><img alt="${i18n.responseTimeGraphAlt || "Response time graph"}" src="./graphs/${page.slug}/response-time-week.png" height="20"> ${page.timeWeek}${i18n.ms || "ms"}</summary><br><a href="${website}/history/${page.slug}"><img alt="${i18n.responseTime || "Response time"} ${page.time}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fresponse-time.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.responseTimeDay || "24-hour response time"} ${page.timeDay}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fresponse-time-day.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.responseTimeWeek || "7-day response time"} ${page.timeWeek}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fresponse-time-week.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.responseTimeMonth || "30-day response time"} ${page.timeMonth}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fresponse-time-month.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.responseTimeYear || "1-year response time"} ${page.timeYear}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fresponse-time-year.json"></a></details> | <details><summary><a href="${website}/history/${page.slug}">${page.uptimeWeek}</a></summary><a href="${website}/history/${page.slug}"><img alt="${i18n.uptime || "All-time uptime"} ${page.uptime}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fuptime.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.uptimeDay || "24-hour uptime"} ${page.uptimeDay}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fuptime-day.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.uptimeWeek || "7-day uptime"} ${page.uptimeWeek}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fuptime-week.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.uptimeMonth || "30-day uptime"} ${page.uptimeMonth}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fuptime-month.json"></a><br><a href="${website}/history/${page.slug}"><img alt="${i18n.uptimeYear || "1-year uptime"} ${page.uptimeYear}" src="https://img.shields.io/endpoint?url=${encodeURIComponent(apiBaseUrl)}%2F${owner}%2F${repo}%2FHEAD%2Fapi%2F${page.slug}%2Fuptime-year.json"></a></details>`)
            .join("\n")}
