...
const introComment = async () => `# This file was generated by cythb/uptime-monitor@${await getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: cythb/uptime-monitor@${await getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
